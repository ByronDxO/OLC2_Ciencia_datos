...
import { getGraphVelocity } from '../../../Api/Route';
...
function Velocity(props){ 
    ...
    const [ title, setTitle ] = useState('Velocidad');
    ...
    async function getGraph(){
        ...
        try {
            var query = await getGraphVelocity(id, fecha1, fecha2, limit);
    ...
    return(
        ...
        <div className="row">
            <h3 className="align-text center">Grafica de Velocidad</h3>
