...
import { getGraphRate } from '../../../Api/Route';
...
function Rate(props){ 
    ...
    const [ title, setTitle ] = useState('Rate');
    ...
    async function getGraph(){
        ...
        try {
            var query = await getGraphRate(id, fecha1, fecha2, limit);
    ...
    return(
        ...
        <div className="row">
            <h3 className="align-text center">Grafica de Ritmo</h3>
            <div className="row">
